...
export function Skills() {
  return (
    <section id="skills" className="py-32 max-w-10xl mx-auto px-8">
      <AnimatedSection>
        ...
        {skillGroups.map((group, i) => (
          <AnimatedSection key={group.category} delay={i * 100} className="bg-surface-low p-8 rounded-xl space-y-6">
            <div className="flex items-center gap-3 min-w-max">
              ...
              <h3 className="text-on-surface font-bold uppercase tracking-widest text-sm whitespace-nowrap">{group.category}</h3>
            </div>
