...
export const projects: Project[] = [
  {
    ...
    summary:
      "A modern furniture e-commerce app with real-time product updates, Cognito authentication, and a responsive storefront built on AWS Amplify Gen 2.",
    github: "https://github.com/dnggngn825/amplify-vite-react-app",
    contributors: [{ name: "Danny Nguyen", email: "h.danggnguyen@gmail.com" }],
    goal: "Build a full-stack e-commerce storefront for contemporary furniture using AWS Amplify Gen 2, covering product browsing, authentication, wishlists, and a checkout flow.",
    whatWasDone: [
      "Implemented product CRUD with real-time updates via Amplify observeQuery and AppSync GraphQL.",
      "Set up public API key auth for browsing and Cognito-based auth for account and wishlist pages.",
      "Built client-side routing with layout route pattern for home, account, cart, and wishlist views.",
      "Created a RequireAuth component and useAuth hook for shared authentication logic.",
      "Wrote a seed script to populate 50 products across 5 categories.",
      "Designed a responsive product grid (1/2/4 columns) with category filter navigation.",
      "Added a transparent-to-frosted navbar on scroll and an animated hero heading.",
    ],
    improvements: [
      "Add product detail page with variant selection (size, colour, material).",
      "Implement shopping cart state management, quantity controls, and checkout flow.",
      "Add robust filtering with price range, rating, and in-stock filters synced to URL params.",
      "Integrate sort options (price, rating, newest) for the product grid.",
    ],
  },
  {
    id: "personal-website",
    ...
    summary:
      "A personal portfolio website built with React and TypeScript, featuring a custom design system, smooth animations, and a responsive layout to showcase projects and experience.",
  ...
  },
  {
    ...
    summary:
      "A mobile robot that autonomously navigates a small-scale warehouse, performing sequential pick-and-drop tasks between a dispenser and receptacle using A* path planning and PID motion control.",
    ...
    images: [
      {
        src: amrWarehouse,
        alt: "Warehouse layout diagram",
        caption: "Warehouse grid layout with path nodes",
      },
      {
        src: amrSetup,
        alt: "Path planning setup",
        caption: "Path planning initialisation",
      },
      {
        src: amrExample,
        alt: "Example path",
        caption: "A* computed path example",
      },
      {
        src: amrTraj,
        alt: "Trajectory tracking",
        caption: "Trajectory tracking result",
      },
      {
        src: amrDiagram,
        alt: "Systems-level diagram",
...

  {
    ...
    summary:
      "A 4-DoF serial robot arm designed to pick and place chess pieces on a chessboard, implementing Forward/Inverse Kinematics via Denavit-Hartenberg tables, task-space velocity control, and cubic polynomial trajectory generation.",
    ...
    images: [
      ...
      {
        src: chessbotSchematic,
        alt: "Circuit schematic",
        caption: "Arduino wiring schematic",
      },
      {
        src: chessbotWorkspace,
        alt: "Workspace side and top view",
        caption: "Robot workspace visualisation",
      },
      {
        src: chessbotReachable,
        alt: "Reachable workspace",
        caption: "Reachable workspace boundary",
      },
      {
        src: chessbotIk,
        alt: "IK result",
        caption: "Inverse kinematics result",
      },
      {
        src: chessbotCorner,
        alt: "Corner visual verification",
        caption: "End-effector corner alignment",
      },
      {
        src: chessbotSide,
        alt: "Side-view trajectory",
        caption: "Side-view trajectory tracking",
      },
      {
        src: chessbotResult,
        alt: "Trajectory result",
        caption: "Final trajectory execution result",
      },
    ],
    richSections: [
      {
...

  {
    ...
    summary:
      "Capstone project: design and implementation of an autonomous steering system for a Formula SAE vehicle, integrating CANopen motor control, structural FEA analysis, and simulation-based algorithm validation.",
    contributors: [{ name: "Danny Nguyen" }],
...

  {
    ...
    summary:
      "An affordable, lightweight prosthetic arm prototype built for Colombian charity eNABLE. EMG sensor signals are processed by an Arduino to control DC servo motors, enabling various hand gestures.",
...

  {
    ...
    tech: ["Fusion 360"],
    summary:
      "An affordable 3D-printed dental mirror redesign created during a hackathon. Achieved runner-up by addressing ergonomics, sterilisability, and cost barriers in existing dental instruments.",
